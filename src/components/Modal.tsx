...
function Modal() {
  ...
  return (
    <>
      ...
      <button id="launchModal" type="button" className="btn d-none"
          ...
          <div className={`modal-content border-0 py-4 px-3`}>
            ...
            <div className="d-block mx-auto pt-4">
              <div className="d-flex">
                ...
                {modalConfig.showBtn ? <button type="button" className="btn btn-danger mx-2"
                  data-bs-dismiss="modal" onClick={modalConfig.action}>Continue</button> : null}
              </div>
            </div>
          </div>
        </div>
